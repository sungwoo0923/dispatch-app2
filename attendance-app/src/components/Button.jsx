...
export default function Button({
  ...
  return (
    <As
      className={`inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl font-medium transition-colors disabled:cursor-not-allowed ${VARIANTS[variant]} ${sizeClass} ${className}`}
      {...props}
    >
      {children}
    </As>
